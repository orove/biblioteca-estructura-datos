 ...
 */
public class ListaEnlazadaSimpleImplTest {

    @Test
    public void testListaEnlazadaSimpleImpl() {
        System.out.println("iniciando prueba unitaria del constructor: ListaEnlazadaSimpleImpl");
        Lista<String> lista = new ListaEnlazadaSimpleImpl();
    ...
    public void testTotalElementos() {
        ...
        Lista<Integer> lista = new ListaEnlazadaSimpleImpl();
        int expResult = 0;
    ...
    public void testVisualizar() {
        ...
        try {
            ...
            Logger.getLogger(ListaEnlazadaSimpleImplTest.class.getName()).log(Level.SEVERE, null, ex);
        }
